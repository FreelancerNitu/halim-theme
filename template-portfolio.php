        ...
        <div class="portfolio-menu mb-40 text-center">
          ...
          $portfolio_menus = get_terms('portfolio-cat');
           foreach($portfolio_menus as $portfolio_menu){
            ?>
          <button data-filter=".<?php echo $portfolio_menu->slug; ?>" class=""><?php echo $portfolio_menu->name; ?>
          </button>
        ...
        <div class="single-portfolio">
          ...
          <div class="portfolio-hover">
            <div class="portfolio-content">
              <h3><a href="<?php esc_url(the_permalink());?>" class=""><i class="fa fa-link"></i> <?php the_title();?>
                  <span><?php echo $portfolio_item->name; ?></span></a></h3>
            </div>
          </div>
        </div>
      </div>
